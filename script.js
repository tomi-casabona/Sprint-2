...
biggerName = (name1, name2) => {
    name1>name2?console.log(name1 + " es mas grande"):console.log(name2 + " es mas grande")
}
...
compareNum = (num) => num>0?console.log(num + "es Mayor que 0"):num<0?console.log(num + "es Menor que cero"):console.log(num +" es cero");
compareNum(2);
compareNum(-1);
compareNum(0);

trobarMax = (a,b,c) => {
    a>b&&a>c?console.log(a + " es el numero mayor"):
    b>a&&b>c?console.log(b + " es el numero mayor"):
    c>a&&c>b?console.log(c + " es el num mayor"):
...
unArray.forEach(e => {
    e % 2 > 0 ? console.log(e + " es un numero impar") : console.log(e + " es un numero par");
});
}
parOImpar(unArray)
